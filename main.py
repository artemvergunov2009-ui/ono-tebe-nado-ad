                ...
                if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                    ...
                    if user_id in users_state and users_state[user_id].get("step") == "wait_food_photo":
                        try:
                            ...
                            if photo_url:
                                send_message(user_id, "Фото получено. Нейросеть NEXUS анализирует состав тарелки... Огромная просьба не тыкать на все кнопки из-за того что ИИ долго отвечает!!!")
